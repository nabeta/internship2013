...
#  db.execute("UPDATE identifier set body = ? WHERE id = ?", issn, update_id.to_i)
  ...
  print  "Location: http://komorido.nims.go.jp/~a012427/detail.cgi?id=#{update_id}\n"
  print("\n")
else
...
print("<html>\n")
print("<head>\n")
printf('<meta http-equiv="refresh" content="5; URL=http://komorido.nims.go.jp/~a012427/edit.cgi?id=%s">',update_id.to_s)
...
print('<a href="http://komorido.nims.go.jp/~a012427/issn.cgi?">TOP</a>'"\n")
